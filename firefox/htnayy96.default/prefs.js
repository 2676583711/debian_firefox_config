...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1560343394);
user_pref("browser.laterrun.bookkeeping.sessionCount", 1);
user_pref("browser.laterrun.enabled", true);
user_pref("browser.migration.version", 66);
user_pref("browser.newtabpage.activity-stream.impressionId", "{1593a642-dd31-4c96-81d1-a5b1a48ecfbb}");
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1560268800);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1560343404905");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1560347004905");
user_pref("browser.search.countryCode", "CN");
user_pref("browser.search.region", "CN");
user_pref("browser.slowStartup.averageTime", 6483);
...
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1560343402120");
...
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"d239b54a-7101-42f1-a274-c65858143497\"}");
...
user_pref("security.sandbox.content.tempDirSuffix", "e37cd13b-fade-4b94-a86c-252095f2edad");
user_pref("signon.importedFromSqlite", true);
user_pref("toolkit.startup.last_success", 1560343390);
user_pref("toolkit.telemetry.cachedClientID", "fcadd9c9-fa74-4ae6-a2fd-ebfc429ff870");
